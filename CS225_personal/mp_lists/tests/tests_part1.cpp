...
TEST_CASE("My split test", "[part=1]")
{
    List<int> list;
    List<int> slist = list.split(2);
    List<int> slist2 = list.split(-50);
    List<int> slist3 = list.split(0);
    SUCCEED("Didn't crash!");
}
TEST_CASE("My split test2", "[part=1]")
{
    List<int> list;
    list.insertBack(1);
...
TEST_CASE("My split test3", "[part=1]")
{
    List<int> list;
    list.insertBack(1);
    list.insertBack(2);
...
TEST_CASE("My split test4", "[part=1]")
{
    List<int> list;
    list.insertBack(1);
    list.insertBack(2);
